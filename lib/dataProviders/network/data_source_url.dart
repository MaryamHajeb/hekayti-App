class DataSourceURL {
     ...
     static String baseUrl = 'http://192.168.43.202:8000/api/';
     ...
     static String upload_accuracy='upload_accuracy';
     static String upload_completion='upload_completion';
     static String update_Accuracy='updateAccuracy';

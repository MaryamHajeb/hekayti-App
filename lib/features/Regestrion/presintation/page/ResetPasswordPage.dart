              ...
              child: Container(
                ...
                child: Stack(
                  ...
                  children: [
                                      ...
                                      if(_signupFormKey.currentState!.validate()){
                                       ...
                                       if(await networkInfo.isConnected){
                                         ...
                                         await RemoteDataProvider(client: sl()).sendData(
                                           ...
                                           'updated_at': intl.DateFormat('yyyy-MM-ddTHH:mm:ss.ssssZ').format(DateTime.now().toUtc()),
                                           'email': userModel!.email,
                                           'level': userModel!.level.toString(),
                                           'character': userModel!.character.toString(),
                                           'password': userModel!.password.toString(),
                                           'user_name': userModel!.user_name.toString(),
                    ...
                    Visibility(visible: visible,child: Center(child: initApp(' جاري تعديل كلمه المرور......'),),),
